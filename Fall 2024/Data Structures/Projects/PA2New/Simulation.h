...
{
    public:
     Simulation(int L, int gridSize, int V, const std::string& logFileName,int perCoins,int perNothing,int perGoomba,int perKoopa,int perMushroom);
     ~Simulation();

     void simulate(FileProcessor& fileProcessor);
